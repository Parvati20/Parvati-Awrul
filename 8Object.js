// object:-an object is collection of properties and a property is an association between a Name(or key) and Value. it is non primitive data Types.
                                                // or
// in object, we have properties in the form of key and value pairs.
// * The function of objects is that you can create key value pairs.
// *we can access the value using key.``

// Use of object:-object can create a mapping of students marks.
...
//     class:"12th"
// }
// console.log(obj.name,"this is an object") //for acccess a particular value of an object
// console.log(Object.values(obj)) //for access all properties of object
