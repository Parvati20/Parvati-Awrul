...
// In JavaScript, an event is an action or occurrence that happens in the browser that the user can respond to. 
// Events can be triggered by user interactions, such as clicking a button, moving the mouse, pressing keys on the keyboard, or even loading a page.

// What is Event Delegation?
// Event delegation is a technique in JavaScript where you attach a single event listener to a parent element instead of adding separate event listeners to each child element.
//  This approach allows you to manage multiple child elements efficiently, especially if the number of child elements can change dynamically (like adding or removing items).


// Event Propagation: The process of how events travel through the DOM (either bubbling up or capturing down).
// Event Bubbling: The event starts from the innermost element and bubbles up to the parent elements.
// Event Capturing: The event starts from the outermost element and goes down to the innermost element